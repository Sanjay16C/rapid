...
def search_trains(source: str = Query(...), destination: str = Query(...)):
    ...
    for train in direct_trains:
        ...
        if src_idx is not None and dest_idx is not None and src_idx < dest_idx:
            ...
            route_segment = [s["station"] for s in stops[src_idx:dest_idx + 1]]  # 🔹 Route list
            ...
            results.append({
                ...
                "route": route_segment  # 🔹 Added route info
            })
        ...
        for hub_idx in range(src_idx + 1, len(stops1)):
            ...
            for train2 in trains_from_hub:
                ...
                if hub_idx2 is not None and dest_idx2 is not None and hub_idx2 < dest_idx2:
                    ...
                    route1 = [s["station"] for s in stops1[src_idx:hub_idx + 1]]  # 🔹 First leg
                    route2 = [s["station"] for s in stops2[hub_idx2:dest_idx2 + 1]]  # 🔹 Second leg
                    ...
                    results.append({
                        ...
                        "route": [route1, route2]  # 🔹 Two routes for connecting trains
                    })
